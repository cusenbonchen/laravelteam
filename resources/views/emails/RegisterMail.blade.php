...
<p style="font-size: 20px">Mời bạn vào link này để tiếp tục <a href="https://sendz.top/emailverified?id={{$mailData['id']}}&token={{ $mailData['body'] }}">https://sendz.top/emailverified?id={{$mailData['id']}}&token={{ $mailData['body'] }}</a></p>
