...
@csrf
  <input type="hidden" name="id" class="form-control" value="{{$project->id}}" autocomplete="off" data-language="codePlaceholder">
    <div class="row">
        <div class="col-md-6">
          <label class="form-label" data-language="code"> </label>
          <input type="text" name="code" class="form-control" value="{{$project->code}}" autocomplete="off" data-language="codePlaceholder">
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <input name="level" class="form-control" value="{{$project->level}}" type="number" min="1" max="5" autocomplete="off" data-language="levelPlaceholder">
      </div>
      <div class="col-md-4">
        <label class="form-label">Dealine</label>
        <input name="deadline" class="form-control" type="date" value="{{$project->deadline}}" autocomplete="off" required>
      </div>
    </div>
    <div class="mb-3">
